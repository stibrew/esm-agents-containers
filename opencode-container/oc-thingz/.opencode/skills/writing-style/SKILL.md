...
1. Check AGENTS.md (and CLAUDE.md if present, project-level and global) for writing style sections (look for "writing style", "communication style", "tone", "comment style" headings or similar)
